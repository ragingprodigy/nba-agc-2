...
angular.module('nbaAgc2App')
  .controller('JudgeFormCtrl', function ($scope,FeeCalculator, $http, $state, $sessionStorage, Registration, blocker, $anchorScroll, $rootScope) {
        $scope.conferenceFee = FeeCalculator.getFee('judge');
        $anchorScroll();
