...
exports.sendBankRegistrationSuccessText = function(registration, next) {
    var message = 'Dear ' + registration.firstName + ', your NBA AGC 2016 registration has been confirmed! Following the receipt of Your Payment. Your registration code is: ' + registration.registrationCode;
...
exports.sendWebPaySuccessText = function(registration, next) {
    var message = 'Dear ' + registration.firstName + ', your NBA AGC 2016 registration has been confirmed following receipt of your payment! Your registration code is: ' + registration.registrationCode;
...
exports.sendBankPaySuccessMail = function(registration, next) {
    var emailData = '<div style="margin:0; padding:0; font-family:Segoe UI,Segoe UI,Arial,Sans-Serif;"><div style="margin:0; padding:0;"><div style="max-width:600px; margin: 10px auto 0; background-color: green;"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="display:block; max-width:600px"><tbody><tr><td colspan="3" height="15"></td></tr><tr><td width="20"></td><td style="text-align: center;"><a href="http://nigerianbar.org.ng"><img src="https://nba-agc.org/assets/images/561e82db.banner1.jpg"></a></td></tr><tr><td colspan="3"><h3 align="left" valign="top" style="line-height:41px;font-size: 28px;font-family:Segoe UI Light,Segoe UI,Arial,Sans-Serif;color: #FFFFFF; text-align:center; margin: 10px auto 0;">NBA Annual General Conference 2016</h3></td></tr><tr><td colspan="3" height="15"></td></tr></tbody></table></div><div style="max-width:600px; margin:0 auto; border-left: 1px solid #CCC; border-right: 1px solid #CCC; border-bottom: 1px solid #CCC; padding-bottom: 20px;"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="display:block; max-width:600px;"><tbody><tr><td colspan="3" height="20"></td></tr><tr><td width="40"></td><td align="left" valign="top"><table width="520" border="0" cellspacing="0" cellpadding="0" style="display:block"><tbody><tr><td align="left" valign="top" style="line-height:36px;font-size:23px;font-family:Segoe UI Light,Segoe UI,Arial,Sans-Serif;color: green;padding-right:15px;padding-left:0px"><b>Dear Registrant</b></td></tr></tbody></table></td><td width="40"></td></tr><tr><td colspan="3" height="20"></td></tr><tr><td width="40"></td><td align="left" valign="top"><table width="520" border="0" cellspacing="0" cellpadding="0" style="display:block"><tbody><tr><td align="left" valign="top" style="line-height:19px;font-size:15px;font-family: Segoe UI,Segoe UI,Arial,Sans-Serif;text-align: justify;color:#000000;padding-right:10px">Your registration for the NBA Annual General Conference 2016 <b>"Democracy And Economic Development"</b> in <b>Port Harcourt</b> from <b>19th - 26th August, 2016</b> has been <b style="color:green;">CONFIRMED</b> following the receipt of your payment.<br><br>Please find below your payment information:<br><br>Registration Code: <b>{{code}}</b><br>Conference Fee: <b>NGN {{fee}}</b><br>Amount Paid: <b>NGN {{amount}}</b><br>Teller No: <b>{{teller}}</b><br>Payment Date: <b>{{date}}</b><br></td></tr><tr><td height="20"></td></tr><tr><td align="left" valign="top" style="line-height:19px;font-size:15px;font-family: Segoe UI,Segoe UI,Arial,Sans-Serif;text-align: justify;color:#000000;padding-right:10px">Additional information regarding the Annual General Conference would be sent to you from time to time.</td></tr><tr><td height="50"></td></tr><tr><td height="30"></td></tr><tr><td align="left" valign="top" style="line-height:19px;font-size:15px;font-family: Segoe UI,Segoe UI,Arial,Sans-Serif;text-align: justify;color:#000000;padding-right:10px">For further enquiries, please call Registration Support on <b>08068619570, 08106721947, 09059999693, 09085524199</b>. </td></tr><tr><td height="50" style="border-bottom:1px solid #CCC;"></td></tr><tr><td align="center" valign="top" style="padding-top:10px"><table><tbody><tr><td width="30%"><img style="max-width:100%" src="http://lawpavilion.com/img/official-logo.png"></td><td style="line-height:19px;font-size:12px;font-family: Segoe UI,Segoe UI,Arial,Sans-Serif;color:#4b4b4b;padding-right:10px; text-align:center;"><span style="color: #00CC39; font-weight:bold;">For Enquiries and Conference Information </span>  Send emails to: registration@nba-agc.org</td></tr></tbody></table></td></tr></tbody></table></td><td width="40"></td></tr></tbody></table></div></div></div>';

    var newMessage = message;
    newMessage.html = emailData.replace('{{code}}', (registration.registrationCode)).replace('{{fee}}', registration.conferenceFee).replace('{{amount}}', registration.bankDeposit).replace('{{teller}}', registration.bankTeller).replace('{{date}}', moment(registration.bankDatePaid).format('ddd, Do MMM YYYY'));
...
exports.sendGroupBankPaySuccessMail = function(invoice, next) {
    ...
    for (var i=0; i<invoice.registrations.length; i++) {
        ...
        delegates += '<li>'+ delegate.prefix + ' ' + delegate.firstName + ' ' + delegate.middleName.substring(0,1) + ' ' + delegate.surname + ' <span style="font-size:small; color: #CCC;">' + delegate.suffix + '</span> ' + ' - <b>' + (delegate.registrationCode) + '</b>' +'</li>';
    }
...
exports.sendBankRegistrationSuccessMail = function(registration, next) {
    ...
    var newMessage = message;
    newMessage.html = emailData.replace('{{code}}', (registration.registrationCode)).replace('{{amount}}', registration.conferenceFee).replace('{{ref}}', registration.bankTeller);
...
exports.sendBankRegistrationText = function(registration, password, next) {
    var message = 'Dear '+ registration.firstName +', Registration Received! Please ensure you make payment to the bank within 48 hours. Here is your Payment Code:'+registration.regCode+'-'+registration.conferenceFee+'. This is not your Registration Code';
...
exports.sendWelcomeMail = function(registration, password, next) {
    var emailData = '<div style="margin:0; padding:0; font-family:Segoe UI,Segoe UI,Arial,Sans-Serif;">    <div style="margin:0; padding:0;"><div style="max-width:600px; margin: 10px auto 0; background-color: green;"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="display:block; max-width:600px"><tbody><tr><td colspan="3" height="15"></td></tr><tr><td width="20"></td><td style="text-align: center;"><a href="http://nigerianbar.org.ng"><img src="https://nba-agc.org/assets/images/561e82db.banner1.jpg"></a></td></tr><tr><td colspan="3"><h3 align="left" valign="top" style="line-height:41px;font-size: 28px;font-family:Segoe UI Light,Segoe UI,Arial,Sans-Serif;color: #FFFFFF; text-align:center; margin: 10px auto 0;">NBA Annual General Conference 2016</h3></td></tr><tr><td colspan="3" height="15"></td></tr></tbody></table></div><div style="max-width:600px; margin:0 auto; border-left: 1px solid #CCC; border-right: 1px solid #CCC; border-bottom: 1px solid #CCC; padding-bottom: 20px;"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="display:block; max-width:600px;"><tbody><tr><td colspan="3" height="20"></td></tr><tr><td width="40"></td><td align="left" valign="top"><table width="520" border="0" cellspacing="0" cellpadding="0" style="display:block"><tbody><tr><td align="left" valign="top" style="line-height:36px;font-size:23px;font-family:Segoe UI Light,Segoe UI,Arial,Sans-Serif;color: green;padding-right:15px;padding-left:0px"><b>Dear Registrant</b></td></tr></tbody></table></td><td width="40"></td></tr><tr><td colspan="3" height="20"></td></tr><tr><td width="40"></td><td align="left" valign="top"><table width="520" border="0" cellspacing="0" cellpadding="0" style="display:block"><tbody><tr><td align="left" valign="top" style="line-height:19px;font-size:15px;font-family: Segoe UI,Segoe UI,Arial,Sans-Serif;text-align: justify;color:#000000;padding-right:10px">Thank you for your interest to attend the NBA Annual General Conference 2016 titled <b>"Democracy And Economic Development"</b> in <b>Port Harcourt</b> from <b>19 - 27 August, 2016</b>.<br><br>You can now access your Conference Account online here: <a href="https://nba-agc.org/myaccount" style="color: green;">https://nba-agc.org/myaccount</a> using the login details below to access your account:<br><br>Email: <b>{{email}}</b><br>Password: <b>{{password}}</b><br><br></td></tr><tr><td height="20"></td></tr><tr><td align="left" valign="top" style="line-height:19px;font-size:15px;font-family: Segoe UI,Segoe UI,Arial,Sans-Serif;text-align: justify;color:#000000;padding-right:10px">Through your account you can print your payment receipt, preview the conference guide and programme, and much more.</td></tr><tr><td height="50"></td></tr><tr><td align="left" valign="top" style="line-height:19px;font-size:25px;font-family: Segoe UI,Segoe UI,Arial,Sans-Serif;color:#000000;padding-right:10px; text-align: center;"><span style="background: green; padding: 10px; border-radius: 5px;"><a href="https://nba-agc.org/" style="color:#FFFFFF; text-decoration:none;">Go To Conference Portal</a></span></td></tr><tr><td height="50"></td></tr><tr><td height="30"></td></tr><tr><td align="left" valign="top" style="line-height:19px;font-size:15px;font-family: Segoe UI,Segoe UI,Arial,Sans-Serif;text-align: justify;color:#000000;padding-right:10px">For further enquiries, please call Registration Support on <b>08068619570, 08106721947, 09059999693, 09085524199</b>. </td></tr><tr><td height="50"' +
        ' style="border-bottom:1px solid #CCC;"></td></tr><tr><td align="center" valign="top" style="padding-top:10px"><table><tbody><tr><td width="30%"><img style="max-width:100%" src="http://lawpavilion.com/img/official-logo.png"></td><td style="line-height:19px;font-size:12px;font-family: Segoe UI,Segoe UI,Arial,Sans-Serif;color:#4b4b4b;padding-right:10px; text-align:center;"><span style="color: #00CC39; font-weight:bold;">For Enquiries and Conference Information </span>  Send emails to: registration@nba-agc.org</td></tr></tbody></table></td></tr></tbody></table></td><td width="40"></td></tr></tbody></table></div></div></div>';
...
exports.sendBankWelcomeMail = function(registration, password, next) {
    var emailData = '<div style="margin:0; padding:0; font-family:Segoe UI,Segoe UI,Arial,Sans-Serif;">    <div style="margin:0; padding:0;"><div style="max-width:600px; margin: 10px auto 0; background-color: green;"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="display:block; max-width:600px"><tbody><tr><td colspan="3" height="15"></td></tr><tr><td width="20"></td><td style="text-align: center;"><a href="http://nigerianbar.org.ng"><img src="https://nba-agc.org/assets/images/561e82db.banner1.jpg"></a></td></tr><tr><td colspan="3"><h3 align="left" valign="top" style="line-height:41px;font-size: 28px;font-family:Segoe UI Light,Segoe UI,Arial,Sans-Serif;color: #FFFFFF; text-align:center; margin: 10px auto 0;">NBA Annual General Conference 2016</h3></td></tr><tr><td colspan="3" height="15"></td></tr></tbody></table></div><div style="max-width:600px; margin:0 auto; border-left: 1px solid #CCC; border-right: 1px solid #CCC; border-bottom: 1px solid #CCC; padding-bottom: 20px;"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="display:block; max-width:600px;"><tbody><tr><td colspan="3" height="20"></td></tr><tr><td width="40"></td><td align="left" valign="top"><table width="520" border="0" cellspacing="0" cellpadding="0" style="display:block"><tbody><tr><td align="left" valign="top" style="line-height:36px;font-size:23px;font-family:Segoe UI Light,Segoe UI,Arial,Sans-Serif;color: green;padding-right:15px;padding-left:0px"><b>Dear Registrant</b></td></tr></tbody></table></td><td width="40"></td></tr><tr><td colspan="3" height="20"></td></tr><tr><td width="40"></td><td align="left" valign="top"><table width="520" border="0" cellspacing="0" cellpadding="0" style="display:block"><tbody><tr><td align="left" valign="top" style="line-height:19px;font-size:15px;font-family: Segoe UI,Segoe UI,Arial,Sans-Serif;text-align: justify;color:#000000;padding-right:10px">Thank you for your interest to be part of the NBA Annual General Conference 2016 <b>"Democracy And Economic Development"</b> in <b>Port Harcourt</b> from <b>19th - 26th August, 2016</b>.<br><br><div style="padding: 15px;background-color: rgba(255, 0, 0, 0.1);color: rgb(165, 4, 4);border-radius: 10px;margin-bottom: 20px;">PLEASE NOTE that this message is NOT a payment confirmation. You have selected to pay at the bank. Kindly make payment for the conference at' +
        ' your' +
        ' nearest ACCESS BANK Branch.<br><br><b>Account Name:</b> NBA-AGC ACCOUNT<br><br><b>Account Number:</b> 0 6 9 5 1 7 6 4 9 5 <br><br>Once your payment is confirmed, you will be notified within 48 hours and your Registration Code' +
        ' will be sent to you.</div>In the meantime, you can access your Conference Account online here: <a' +
        ' href="https://nba-agc.org/myaccount" style="color: green;">https://nba-agc.org/myaccount</a> using the login details below to access your account:<br><br>Email: <b>{{email}}</b><br>Password: <b>{{password}}</b><br><br></td></tr><tr><td height="20"></td></tr><tr><td align="left" valign="top" style="line-height:19px;font-size:15px;font-family: Segoe UI,Segoe UI,Arial,Sans-Serif;text-align: justify;color:#000000;padding-right:10px">Through your account you can print your payment receipt, preview the conference guide and programme, and much more.</td></tr><tr><td height="50"></td></tr><tr><td align="left" valign="top" style="line-height:19px;font-size:25px;font-family: Segoe UI,Segoe UI,Arial,Sans-Serif;color:#000000;padding-right:10px; text-align: center;"><span style="background: green; padding: 10px; border-radius: 5px;"><a href="https://nba-agc.org/" style="color:#FFFFFF; text-decoration:none;">Go To Conference Portal</a></span></td></tr><tr><td height="50"></td></tr><tr><td height="30"></td></tr><tr><td align="left" valign="top" style="line-height:19px;font-size:15px;font-family: Segoe UI,Segoe UI,Arial,Sans-Serif;text-align: justify;color:#000000;padding-right:10px"> For further enquiries, please call Registration Support on <b>08068619570, 08106721947, 09059999693, 09085524199</b>. </td></tr><tr><td height="50" style="border-bottom:1px solid' +
        ' #CCC;"></td></tr><tr><td align="center" valign="top" style="padding-top:10px"><table><tbody><tr><td width="30%"><img style="max-width:100%" src="http://lawpavilion.com/img/official-logo.png"></td><td style="line-height:19px;font-size:12px;font-family: Segoe UI,Segoe UI,Arial,Sans-Serif;color:#4b4b4b;padding-right:10px; text-align:center;"><span style="color: #00CC39; font-weight:bold;">For Enquiries and Conference Information </span>  Send emails to:' +
        ' registration@nba-agc.org</td></tr></tbody></table></td></tr></tbody></table></td><td width="40"></td></tr></tbody></table></div></div></div>';
...
exports.sendGeneral = function(registration, next) {
    ...
    var url = 'http://52.206.236.158/mcast_ws_v2/index.php?user='+process.env.MCAST_USERNAME+'&password='+process.env.MCAST_PASSWORD+'&from='+process.env.SMS_SENDER+'&to='+destination+'&message='+__message+'&type=json';
...
exports.sendGeneralEmail = function(registration, next) {
    ...
    var emailData = '<div style="margin:0; padding:0; font-family:Segoe UI,Segoe UI,Arial,Sans-Serif;"><div style="margin:0; padding:0;"><div style="max-width:600px; margin: 10px auto 0; background-color: green;"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="display:block; max-width:600px"><tbody><tr><td colspan="3" height="15"></td></tr><tr><td width="20"></td><td style="text-align: center;"><a href="http://nigerianbar.org.ng"><img src="https://nba-agc.org/assets/images/561e82db.banner1.jpg"></a></td></tr><tr><td colspan="3"><h3 align="left" valign="top" style="line-height:41px;font-size: 28px;font-family:Segoe UI Light,Segoe UI,Arial,Sans-Serif;color: #FFFFFF; text-align:center; margin: 10px auto 0;">NBA Annual General Conference 2016</h3></td></tr><tr><td colspan="3" height="15"></td></tr></tbody></table></div><div style="max-width:600px; margin:0 auto; border-left: 1px solid #CCC; border-right: 1px solid #CCC; border-bottom: 1px solid #CCC; padding-bottom: 20px;"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="display:block; max-width:600px;"><tbody><tr><td colspan="3" height="20"></td></tr><tr><td width="40"></td><td align="left" valign="top"><table width="520" border="0" cellspacing="0" cellpadding="0" style="display:block"><tbody><tr><td align="left" valign="top" style="line-height:36px;font-size:23px;font-family:Segoe UI Light,Segoe UI,Arial,Sans-Serif;color: green;padding-right:15px;padding-left:0px"> </td></tr></tbody></table></td><td width="40"></td></tr><tr><td colspan="3" height="20"></td></tr><tr><td width="40"></td><td align="left" valign="top"><table width="520" border="0" cellspacing="0" cellpadding="0" style="display:block"><tbody><tr><td align="left" valign="top" style="line-height:19px;font-size:15px;font-family: Segoe UI,Segoe UI,Arial,Sans-Serif;text-align: justify;color:#000000;padding-right:10px">Dear Learned Colleague,<br>You can choose to have access to the Conference Daily Schedules and also Conference Programme by clicking the link belows <br><br>For daily Schedules click : <a href="https://nba-agc.org/assets/images/conferenceProgram/NBA2016AGCDailyScheduleofSessions.pdf">NBA 2016 AGC Daily Schedule of Sessions</a> <br> For complete Programme click : <a href="https://nba-agc.org/assets/images/conferenceProgram/AGC2016Programme.pdf">AGC 2016 Programme</a><br> Or you can copy this link to your browser to download it. <br> https://nba-agc.org/assets/images/conferenceProgram/NBA2016AGCDailyScheduleofSessions.pdf <br>https://nba-agc.org/assets/images/conferenceProgram/AGC2016Programme.pdf<br> Thank You</td></tr><tr><td height="50"></td></tr><tr><td align="left" valign="top" style="line-height:19px;font-size:25px;font-family: Segoe UI,Segoe UI,Arial,Sans-Serif;color:#000000;padding-right:10px; text-align: center;"><span style="background: green; padding: 10px; border-radius: 5px;"></span></td></tr><tr><td height="50"></td></tr><tr><td height="30"></td></tr><tr><td align="left" valign="top" style="line-height:19px;font-size:15px;font-family: Segoe UI,Segoe UI,Arial,Sans-Serif;color:#000000;padding-right:10px">For further enquiries, please call Registration Support on <b>08068619570, 08106721947, 09059999693, 09085524199</b>. </td></tr><tr><td height="50" style="border-bottom:1px solid #CCC;"></td></tr><tr><td align="center" valign="top" style="padding-top:10px"><table><tbody><tr><td width="30%"><img style="max-width:100%" src="http://lawpavilion.com/img/official-logo.png"></td><td style="line-height:19px;font-size:12px;font-family: Segoe UI,Segoe UI,Arial,Sans-Serif;color:#4b4b4b;padding-right:10px; text-align:center;"><span style="color: #00CC39; font-weight:bold;">For Enquiries and Conference Information </span>  Send emails to: registration@nba-agc.org</td></tr></tbody></table></td></tr></tbody></table></td><td width="40"></td></tr></tbody></table></div></div></div>';

    newMessage.html = emailData;
    newMessage.subject = 'NBA AGC CONFERENCE PROGRAMME AND DAILY SCHEDULE';
    newMessage.to = [registration.email];
