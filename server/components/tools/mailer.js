...
exports.sendBankRegistrationSuccessText = function(registration, next) {
    var message = 'Dear ' + registration.firstName + ', your NBA AGC 2016 registration has been confirmed! Your registration code is: ' + registration.registrationCode;
...
exports.sendBankRegistrationText = function(registration, password, next) {
    var message = 'Dear '+ registration.firstName +', Registration Received! Please ensure you make payment to the bank within 48 hours  to avoid cancellation of this registration.';
